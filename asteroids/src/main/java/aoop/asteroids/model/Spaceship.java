...
public class Spaceship extends GameObject {
     ...
     * @return a Color which will be assigned to this ship.
     */

    private Color setShipColor() {
     ...
     * @param nickName string name of ship.
     */
    ...
    public Spaceship clone() {
        Spaceship spaceship = new Spaceship(this.getLocation(), this.velocityX, this.velocityY, this.radius, this.direction, this.up, this.score);
        spaceship.setColor(this.color);
        spaceship.setNickName(this.nickName);
        return spaceship;
    }
